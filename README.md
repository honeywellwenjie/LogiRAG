...
#### Retrieval Mode Flowcharts

<details>
<summary><b>🧠 Reasoning Mode</b> - Pure LLM tree navigation</summary>
...
└─────────────────────────────────────────────────────────────────┘
                    ...
                    └────────┬────────┘
                             ...
                             ▼
            ┌────────────────────────────────┐
            │  📚 Load All Document Trees    │
            │     (Full tree structure)      │
            └───────────────┬────────────────┘
                            │
                            ▼
            ┌────────────────────────────────┐
            │  🧠 Round 1: High-Level Scan   │
            │  ┌──────────────────────────┐  │
            │  │ LLM analyzes all docs    │  │
            │  │ + top-level sections     │  │
            ...
            │  🧠 Round 2: Deep Search       │
            │  ┌──────────────────────────┐  │
            │  │ LLM drills into selected │  │
            │  │ sections → find specific │  │
            │  │ nodes with answers       │  │
            │  └──────────────────────────┘  │
            └───────────────┬────────────────┘
                            │
...
<details>
<summary><b>📊 Vector Mode</b> - Fast embedding similarity</summary>
...
<details>
<summary><b>🔀 Hybrid Mode (Recommended)</b> - Vector + LLM reasoning</summary>
...
┌───────────────────┐                             │
│ STEP 3: LLM       │◄────────────────────────────┘
│ Reasoning         │   (Only on filtered docs)
│ ┌───────────────┐ │
│ │ Multi-round   │ │
│ │ tree search   │ │
│ │ on 4 docs     │ │
...
│ 📋 Final Results                                  │
│ ┌───────────────────────────────────────────────┐ │
│ │ Node          Final   Vector  Reason  Source │ │
│ │ Resume:0002   0.54    -       0.90    reason │ │
│ │ Index:0001    0.13    0.33    -       vector │ │
│ └───────────────────────────────────────────────┘ │
└───────────────────────────────────────────────────┘
```
